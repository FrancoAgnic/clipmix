...
- **🖼️ Fotos** — **moodboard / carrusel panorámico** para Instagram: un lienzo largo horizontal con **fondo de color o degradado de 2 colores** (a lo largo de todo el lienzo). Las fotos que agregas quedan en un **cajón** y las sueltas al lienzo **de a una** (tocando cada una), para no amontonarlas. Tiene **deshacer/rehacer** (↶ ↷). Colocas fotos **libremente** (mover, escalar, rotar, superponer con capas al frente/al fondo). Se corta en varias slides que, al deslizar en IG, se ven **conectadas** — una foto puede quedar entre dos slides y continuar. Te desplazas por el lienzo con una **barra ↔** (arrastrar mueve la foto, no el fondo). Cada foto puede llevar un **marco** (color y grosor) y **difuminar sus bordes** para fusionarse sin costura con las de atrás. También puedes **agregar videos**: las slides con video se exportan como **MP4** y las de solo fotos como **JPG** (carrusel mixto). Las fotos/videos que agregas quedan en un **cajón** y las sueltas al lienzo de a una. Optimizado para muchas fotos: usa **proxies** de baja resolución y dibuja solo la ventana visible mientras editas (fluido con 30+ fotos), y **exporta en alta**. Descarga una imagen por slide (súbelas en orden 1, 2, 3…). Se autoguarda.
